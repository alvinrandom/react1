...
var GroupedListSection = /** @class */ (function (_super) {
    ...
    GroupedListSection.prototype.render = function () {
        ...
        return (React.createElement("div", __assign({ ref: this._root }, (isDraggable && { draggable: true }), { className: css(groupedListClassNames && groupedListClassNames.group, this._getDroppingClassName()), role: "presentation" }),
            ...
            group && group.isCollapsed ? null : hasNestedGroups ? (React.createElement(List, { role: "group", ref: this._list, items: group ? group.children : [], onRenderCell: this._renderSubGroup, getItemCountForPage: this._returnOne, onShouldVirtualize: onShouldVirtualize, version: version, id: this._id })) : (this._onRenderGroup(renderCount)),
    ...
    GroupedListSection.prototype._onRenderGroup = function (renderCount) {
        ...
        return (React.createElement(List, __assign({ role: groupProps && groupProps.role ? groupProps.role : 'group', "aria-label": (_a = group) === null || _a === void 0 ? void 0 : _a.name, items: items, onRenderCell: this._onRenderGroupCell(onRenderCell, groupNestingDepth), ref: this._list, renderCount: Math.min(count, renderCount), startIndex: startIndex, onShouldVirtualize: onShouldVirtualize, id: this._id }, listProps)));
    };
